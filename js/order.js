...
function displayCartItems() {
  ...
  if (cart && cart.length > 0) {
    ...
    cart.forEach(function (item) {
      ...
      // Define the path
      const path = 'foodItems2/Juice/-NjqWf22VQqRO7rfPbqc';
    ...
    for (var itemName in itemQuantities) {
     ...
     <div class="item-info">
        ...
        <div class="item-price">
            ...
            <button class="cancel-item" onclick="removeItem('${itemName}')">X</button>
        </div>
     </div>
`;
  cartList.appendChild(listItem);
    ...
    var totalAmountSpan = document.querySelector(".innercontainer2 span");
              ...
              snapshot.forEach(child => {
                  child.forEach(child2 => {
                      ...
                      if (item.foodName === itemname && item.quantity > 0) {
                        ...
                        console.log(foodname,"avilable quantity is less!");
                      }
                  });
              });
          })
