              ...
              .then(function (snapshot) {
                ...
                if (tokenData && tokenData.foodItem && tokenData.time) {
                  ...
                  const updateData = {
                    ...
                    //    // display page code
                    //  prepared_display.child(token).set({
                    //   TokenNumber: token,
                    //   Gmail: gmail,
                    //   Status: "Prepared",
                    // })
                    // .then(function () {
                    //   console.log(" Prepared Display Created successfully.");
                    ...
                    // })
                    // .catch(function (error) {
                    //   console.error("Prepared Display Creating error:", error);
                    // });
                  // / -------------------------------------------
                  let gmail = tokenData.gmail;
                  console.log(gmail, tokenData.token);
